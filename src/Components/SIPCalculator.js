...
function SipCalculator() {
	...
	// const [amountOfCryptoBought, setamountOfCryptoBought] = useState('');
	// const [valueOfCryptoToday, setvalueOfCryptoToday] = useState('');
	...
	// 			setResult(((valueOfCryptoToday - totallyInvestedAmount) / totallyInvestedAmount) * 100);
